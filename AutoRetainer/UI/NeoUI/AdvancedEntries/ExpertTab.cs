...
public class ExpertTab : NeoUIEntry
{
    ...
    public override NuiBuilder Builder { get; init; } = new NuiBuilder()
        ...
        .Checkbox(Loc.T("Do not show plugin status icons"), () => ref C.HideOverlayIcons)
        .Checkbox(Loc.T("Display multi mode type selector"), () => ref C.DisplayMMType)
        .Checkbox(Loc.T("Display deployables checkbox in workshop"), () => ref C.ShowDeployables)
        ...
        .Checkbox(Loc.T("Artisan integration"), () => ref C.ArtisanIntegration, Loc.T("Automatically enables AutoRetainer while Artisan is Pauses Artisan operation when ventures are ready to be collected and a retainer bell is within range. Once ventures have been dealt with Artisan will be enabled and resume whatever it was doing."))
