...
public class MultiModeRetainers : NeoUIEntry
{
    ...
    public override NuiBuilder Builder { get; init; } = new NuiBuilder()
        ...
        .DragInt(60f, Loc.T("Advance Relog Threshold"), () => ref C.MultiModeRetainerConfiguration.AdvanceTimer.ValidateRange(0, 300), 0.1f, 0, 300)
        .SliderInt(100f, Loc.T("Minimum inventory slots to continue operation"), () => ref C.MultiMinInventorySlots.ValidateRange(2, 9999), 2, 30)
        ...
        .Checkbox(Loc.T("Enforce Full Character Rotation"), () => ref C.CharEqualize, Loc.T("Recommended for users with > 15 characters, forces multi mode to make sure ventures are processed on all characters in order before returning to the beginning of the cycle."))
        .Indent()
