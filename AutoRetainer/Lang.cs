...
internal static class Lang
{
    ...
    // Display text for UnlockMode. These are descriptions rather than bare member names on purpose.
    // Upstream fed this hardcoded English table to two of the four unlock-mode combos while the other two fell back to the enum member name;
    // all four now read from here.
    // Built once on first use and reused for the rest of the session.
